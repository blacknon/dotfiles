...
____get_rcdata() {
  ...
  cat ~/dotfiles/{sh/{alias.sh,export.sh,other.sh,functions/{common.sh,exec_1.sh,keybind.sh,replace.sh,iterm2.sh}},bash/{prompt.bash,other.bash,keybind.bash}} \
    ~/_shell/{boco/boco.bash,substitute_line/substitute_line.bash} \
